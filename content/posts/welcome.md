...
A few years passed, and now it doesn't matter which framework I use. As long as the content is written in Markdown, migrating from one framework to another costs nothing, thanks to agents. So I found a nice blog template. It used Hugo. Decision is made, I'll use Hugo then. I asked Codex to set it up, and finally, I've deployed something here.
